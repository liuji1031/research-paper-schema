# Contributing to research-paper-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
research-paper-schema. These guidelines are not strict rules.
...
The research-paper-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the research-paper-schema technical leads
...
[issues]: https://github.com/axle_informatics/research-paper-schema/issues/
[pulls]: https://github.com/axle_informatics/research-paper-schema/pulls/
